...
const file_status_proto_rawDesc = "" +
	"\n" +
	"\fstatus.proto\x12\x1fatakmap.commoncommo.protobuf.v1\"\"\n" +
	"\x06Status\x12\x18\n" +
	"\abattery\x18\x01 \x01(\rR\abatteryB%H\x03Z!meshsat/internal/gateway/takprotob\x06proto3"
...
var file_status_proto_goTypes = []any{
	(*Status)(nil), // 0: atakmap.commoncommo.protobuf.v1.Status
}
