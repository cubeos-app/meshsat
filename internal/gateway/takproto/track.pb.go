...
type Track struct {
	...
	Course        float64                `protobuf:"fixed64,2,opt,name=course,proto3" json:"course,omitempty"`
...
const file_track_proto_rawDesc = "" +
	"\n" +
	"\vtrack.proto\x12\x1fatakmap.commoncommo.protobuf.v1\"5\n" +
	"\x05Track\x12\x14\n" +
	"\x05speed\x18\x01 \x01(\x01R\x05speed\x12\x16\n" +
	"\x06course\x18\x02 \x01(\x01R\x06courseB%H\x03Z!meshsat/internal/gateway/takprotob\x06proto3"
...
var file_track_proto_goTypes = []any{
	(*Track)(nil), // 0: atakmap.commoncommo.protobuf.v1.Track
}
