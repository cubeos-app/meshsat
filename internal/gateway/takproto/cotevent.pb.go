...
type CotEvent struct {
	...
	Opex          string                 `protobuf:"bytes,4,opt,name=opex,proto3" json:"opex,omitempty"`
	...
	StaleTime     uint64                 `protobuf:"varint,8,opt,name=staleTime,proto3" json:"staleTime,omitempty"`
	How           string                 `protobuf:"bytes,9,opt,name=how,proto3" json:"how,omitempty"`
	...
	Hae           float64                `protobuf:"fixed64,12,opt,name=hae,proto3" json:"hae,omitempty"`
	Ce            float64                `protobuf:"fixed64,13,opt,name=ce,proto3" json:"ce,omitempty"`
	Le            float64                `protobuf:"fixed64,14,opt,name=le,proto3" json:"le,omitempty"`
...
const file_cotevent_proto_rawDesc = "" +
	"\n" +
	"\x0ecotevent.proto\x12\x1fatakmap.commoncommo.protobuf.v1\x1a\fdetail.proto\"\xef\x02\n" +
	"\bCotEvent\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12\x16\n" +
	"\x06access\x18\x02 \x01(\tR\x06access\x12\x10\n" +
	"\x03qos\x18\x03 \x01(\tR\x03qos\x12\x12\n" +
	"\x04opex\x18\x04 \x01(\tR\x04opex\x12\x10\n" +
	...
	"\x06detail\x18\x0f \x01(\v2'.atakmap.commoncommo.protobuf.v1.DetailR\x06detailB%H\x03Z!meshsat/internal/gateway/takprotob\x06proto3"
...
var file_cotevent_proto_goTypes = []any{
	(*CotEvent)(nil), // 0: atakmap.commoncommo.protobuf.v1.CotEvent
	(*Detail)(nil),   // 1: atakmap.commoncommo.protobuf.v1.Detail
}
var file_cotevent_proto_depIdxs = []int32{
	1, // 0: atakmap.commoncommo.protobuf.v1.CotEvent.detail:type_name -> atakmap.commoncommo.protobuf.v1.Detail
