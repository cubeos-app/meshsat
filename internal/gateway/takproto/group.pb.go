...
const file_group_proto_rawDesc = "" +
	"\n" +
	"\vgroup.proto\x12\x1fatakmap.commoncommo.protobuf.v1\"/\n" +
	"\x05Group\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n" +
	"\x04role\x18\x02 \x01(\tR\x04roleB%H\x03Z!meshsat/internal/gateway/takprotob\x06proto3"
...
var file_group_proto_goTypes = []any{
	(*Group)(nil), // 0: atakmap.commoncommo.protobuf.v1.Group
}
