...
const file_takmessage_proto_rawDesc = "" +
	"\n" +
	"\x10takmessage.proto\x12\x1fatakmap.commoncommo.protobuf.v1\x1a\x0ecotevent.proto\x1a\x10takcontrol.proto\"\xa0\x01\n" +
	"\n" +
	"TakMessage\x12K\n" +
	"\n" +
	"takControl\x18\x01 \x01(\v2+.atakmap.commoncommo.protobuf.v1.TakControlR\n" +
	"takControl\x12E\n" +
	"\bcotEvent\x18\x02 \x01(\v2).atakmap.commoncommo.protobuf.v1.CotEventR\bcotEventB%H\x03Z!meshsat/internal/gateway/takprotob\x06proto3"
...
var file_takmessage_proto_goTypes = []any{
	(*TakMessage)(nil), // 0: atakmap.commoncommo.protobuf.v1.TakMessage
	(*TakControl)(nil), // 1: atakmap.commoncommo.protobuf.v1.TakControl
	(*CotEvent)(nil),   // 2: atakmap.commoncommo.protobuf.v1.CotEvent
}
var file_takmessage_proto_depIdxs = []int32{
	1, // 0: atakmap.commoncommo.protobuf.v1.TakMessage.takControl:type_name -> atakmap.commoncommo.protobuf.v1.TakControl
	2, // 1: atakmap.commoncommo.protobuf.v1.TakMessage.cotEvent:type_name -> atakmap.commoncommo.protobuf.v1.CotEvent
