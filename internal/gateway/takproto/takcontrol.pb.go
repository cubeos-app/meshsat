...
type TakControl struct {
	...
	ContactUid      string                 `protobuf:"bytes,3,opt,name=contactUid,proto3" json:"contactUid,omitempty"`
...
func (x *TakControl) GetContactUid() string {
	if x != nil {
		return x.ContactUid
	}
	return ""
...
const file_takcontrol_proto_rawDesc = "" +
	"\n" +
	"\x10takcontrol.proto\x12\x1fatakmap.commoncommo.protobuf.v1\"\x80\x01\n" +
	"\n" +
	"TakControl\x12(\n" +
	"\x0fminProtoVersion\x18\x01 \x01(\rR\x0fminProtoVersion\x12(\n" +
	"\x0fmaxProtoVersion\x18\x02 \x01(\rR\x0fmaxProtoVersion\x12\x1e\n" +
	"\n" +
	"contactUid\x18\x03 \x01(\tR\n" +
	"contactUidB%H\x03Z!meshsat/internal/gateway/takprotob\x06proto3"
...
var file_takcontrol_proto_goTypes = []any{
	(*TakControl)(nil), // 0: atakmap.commoncommo.protobuf.v1.TakControl
}
